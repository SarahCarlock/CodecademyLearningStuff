      ...
      {playerChoice && codeyChoice && (
        <div className={styles.results}>
          <div className={choiceStyles}>
            <span className={emojiStyles}>{playerChoice.emoji}</span>
            <p className={nameStyles}>You chose {playerChoice.name}</p>
          </div>
          <div className={choiceStyles}>
            <span className={emojiStyles}>{codeyChoice.emoji}</span>
            <p className={nameStyles}>The computer chose {codeyChoice.name}</p>
          </div>
          <h2 className={resultStyle}>{result}</h2>
